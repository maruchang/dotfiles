...
" ----------1.3 VIM SCRIPTING AND OTHER FUNCTIONALITY-------------------"
...
"open new windows to warrant using up C-M-arrows "
nmap <C-M-Up> <C-w>n
nmap <C-M-Down> <C-w>N
...
" overwrite any of the default mappings."
...
" Overwrite the default hightlight groups"
...
" This feature allows the grouping of bookmarks per root directory. "
" This way bookmarks from other projects are not interfering. "
